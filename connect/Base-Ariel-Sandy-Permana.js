...
const arielFake = {key: {fromMe: false,participant: "0@s.whatsapp.net", ...(m.chat ? { remoteJid: "status@broadcast" } : {}) },message: {imageMessage: {viewOnce: true},},};
...
arielspkece.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, arielFake)
...
arielspkece.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, arielFake)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
arielspkece.send5ButImg(m.chat, MenuList, creator, thumbnail, btn)
}
break
case 'kick': {
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu3)
    arielspkece.sendMessage(m.chat, { image: { url : anu3 }, caption: `${global.botname}`}, { quoted: arielFake } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu6)
    arielspkece.sendMessage(m.chat, { image: { url : anu6 }, caption: `${global.botname}`}, { quoted: arielFake } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu9)
    arielspkece.sendMessage(m.chat, { image: { url : anu9 }, caption: `${global.botname}`}, { quoted: arielFake } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu12)
    arielspkece.sendMessage(m.chat, { image: { url : anu12 }, caption: `${global.botname}`}, { quoted: arielFake } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu15)
    arielspkece.sendMessage(m.chat, { image: { url : anu15 }, caption: `${global.botname}`}, { quoted: arielFake } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu18)
    arielspkece.sendMessage(m.chat, { image: { url : anu18 }, caption: `${global.botname}`}, { quoted: arielFake } )
...
arielspkece.sendMessage(m.chat, {image: { url: arielkeceabis.url },caption: 'Istri Gw'}, { quoted: arielFake })
  }
 break
case 'husbu':
...
let button = [{buttonId: `#husbu`, buttonText: {displayText: 'Next'}, type: 1},]
let hahaRiel = {image: { url: ress.gambar },caption: hii,footer: global.botname,buttons: button,headerType: 4}
arielspkece.sendMessage(m.chat, hahaRiel, { quoted: arielFake })
break
case 'neko2':
var buser = await fetchJson(`https://dt-04.herokuapp.com/api/neko`)
var resss = buser
var hii = `Aespi Botz`
let buttons = [{buttonId: `#neko2`, buttonText: {displayText: 'Next'}, type: 1},]
let buttonMessage = {image: { url: resss.gambar },caption: "Nih Tod",footer: global.botname,buttons: buttons,headerType: 4}
arielspkece.sendMessage(m.chat, buttonMessage, { quoted: arielFake })
break
case 'tinyurl':
if (args.length < 1) return m.reply(`Contoh : ${prefix + command} https://www.mediafire.com/file/mz37h4v0hmaj0ox/Aespi-Botz.apk/file`)
m.reply(`*Tunggu Kak ><*`)
try {
const link = args[0]
...
arielspkece.sendButtonText(m.chat, [{ buttonId: '#quotes', buttonText: { displayText: 'Next' }, type: 1 }], hasil.quotes, creator, arielFake)
break
case 'gombalan':
...
arielspkece.sendButtonText(m.chat, [{ buttonId: '#gombalan', buttonText: { displayText: 'Next' }, type: 1 }], bal, creator, arielFake)
break
case 'orangbego': {
if (!m.isGroup) throw mess.group
let member = participants.map(u => u.id)
...
arielspkece.sendContact(m.chat, global.owner, arielFake)
}
break
...
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await arielspkece.sendVideoAsSticker(m.chat, media, arielFake, { packname: teks1, author: teks2 })
await fs.unlinkSync(encmedia)
} else {
throw `Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`
}
...
case 'ytmp3': case 'ytaudio': {
                ...
                if (!text) throw `Example : ${prefix + command} https://youtu.be/MVwayY1wBHA`
...
let hahaRiel8 = {image: { url: './connect/image/thumb.jpg' },caption: allmenuea,footer: global.botname,buttons: button49,headerType: 4}
arielspkece.sendMessage(m.chat, hahaRiel8, { quoted: arielFake })
}
break
case 'help': case 'menu': {
...
{
title: `Subscribe YT Owner : ArielSP Sus`,
rows: [
...
{
title: `YouTube Link : https://youtube.com/c/ArielSPSus`,
rows: [
...
⌕ #editinfo
⌕ #antilink`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], yaha, creator, arielFake)
break
case 'ownera':
...
⌕ #broadcast
⌕ #setppbot`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], ownerAr, creator, arielFake)
break
case 'funa':
...
⌕ #attp
⌕ #terjemahan`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], funAr, creator, arielFake)
break
case 'cona':
...
⌕ #emojimix
⌕ #emojimix2`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], conAr, creator, ftroli)
break
case 'nulisa':
...
⌕ #foliokiri
⌕ #foliokanan`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], nulisAr, creator, ftok)
break
case 'texta':
...
⌕ #warning <text>
⌕ #denim <text>`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], textAr, creator, arielFake)
break
case 'animea':
...
⌕ #husbu
⌕ #neko2`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], animeAr, creator, ftroli)
break
case 'kisaha':
...
⌕ #kisahnabi yusuf
⌕ #kisahnabi zakariya`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], kisahAr, creator, ftok)
break
case 'downloada':
...
⌕ #tiktokmp3
⌕ #mediafire`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], downloadAr, creator, arielFake)
break
case 'waa':
...
⌕ #waiphonev1
⌕ #waiphonev2`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], waAr, creator, ftroli)
break
case 'sounda':
...
⌕ #sound28
⌕ #sound29`
arielspkece.sendButtonText(m.chat, [{ buttonId: '#menu', buttonText: { displayText: 'Back To Menu 🔙' }, type: 1 }], soundAr, creator, ftok)
break
case 'mediafire':
